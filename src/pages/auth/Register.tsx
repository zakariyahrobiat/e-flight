...
<InputContent heading="Sign up" button={isLoading ? "Signing up..." : "Sign up"} option="Register with your Google Account" discription="Already have an account?" link="/login" text="Sign in here"  isLoading={isLoading}/>
</form>
</div>
<Footer/>
    </BackgroundLayout>
