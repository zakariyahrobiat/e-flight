...
startLocation, endLocation, date}:BarcodeProps) => {
  ...
  return (
    <div className="w-full">
      ...
      <div className="md:flex justify-between gap-2 md:gap-10 bg-slate-100 md:pl-10 my-2 md:my-5 rounded-xl h-full">
        <div className="flex justify-between items-start px-3 py-2 md:py-5 md:w-2/3 h-full">
        ...
        <div className=" flex flex-col h-full justify-between items-end text-right md:w-5/12">
        ...
        <div className="bg-primary-700 md:w-1/3 rounded-xl pt-2 md:py-5 px-5 md:p-5">
        {/* <div className="flex justify-center gap-5 items-center"> 
          <img src={logo} alt="" srcSet="" className="w-[10%]" />
        <p className="font-semibold text-xl text-white">E-flight</p>
        </div> */}
        <div className="py-1 md:py-2 flex justify-between items-center">
